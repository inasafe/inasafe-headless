...
export QGIS_DEBUG=0
export QGIS_LOG_FILE=/tmp/inasafe/headless/logs/qgis.log
export QGIS_DEBUG_FILE=/tmp/inasafe/headless/logs/qgis-debug.log

export PATH=${QGIS_PREFIX_PATH}/bin:$PATH

export INASAFE_WORK_DIR=/tmp/inasafe
export INASAFE_POPULATION_PATH=`pwd`/headless/fixtures/exposure/population.tif
